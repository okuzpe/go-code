...
**Coordinator (D16)** is **implemented** in goclaw: profile `coordinator`, tools `spawn_agent` / `stop_task`, isolated worker sessions — see [goclaw/docs/D16_COORDINATOR_SKETCH.md](goclaw/docs/D16_COORDINATOR_SKETCH.md) and [COORDINATOR_MODE.md](COORDINATOR_MODE.md) (concept vs product reference).
...
> - **Reference-only docs:** [CUSTOM_AGENTS.md](CUSTOM_AGENTS.md), [COORDINATOR_MODE.md](COORDINATOR_MODE.md), [YOLO_CLASSIFIER.md](YOLO_CLASSIFIER.md) may describe a larger product than the Go CLI; trust [`goclaw/CLAUDE.md`](goclaw/CLAUDE.md) for shipped behavior.
