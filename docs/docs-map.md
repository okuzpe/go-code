...
| Date | Change |
|------|--------|
| 2026-04-17 | First-run onboarding **agent profile** step (`onboarding_tui.go`); [usage.md](./goclaw/usage.md) Advanced + first-run list; [manual-tui-checklist.md](./goclaw/manual-tui-checklist.md); [documentation.md](./goclaw/documentation.md) defaults/env anti-drift checklist; [memory-system.md](./reference/memory-system.md) scope legend; [philosophy.md](./goclaw/philosophy.md) Telegram as secondary transport; [code-adjustment-map.md](./reference/code-adjustment-map.md) §2 onboarding paths; [changelog.md](./goclaw/changelog.md). |
