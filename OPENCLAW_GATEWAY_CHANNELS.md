...
Documento de apoyo a [ARCHITECTURE.md](ARCHITECTURE.md) y [OPENCLAW_REFERENCE.md](OPENCLAW_REFERENCE.md). Describe la pieza más **distintiva** de OpenClaw respecto a un “CLI agente” mínimo en Go: el **Gateway** como plano de control y la multiplexación de **canales** de entrada/salida.
